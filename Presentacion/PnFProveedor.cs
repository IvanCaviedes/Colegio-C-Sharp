...
{
    public partial class PnFProveedor : Form
    {
        public PnFProveedor()
        {
            InitializeComponent();
        ...
        private void comboBox2_Enter(object sender, EventArgs e)
        {
            ...
            Lgestionfproveedor fproveedor = new Lgestionfproveedor();
            tabla = fproveedor.Nombreproveedor();
        ...
        private void PnFProveedor_Load(object sender, EventArgs e)
        {
